...
DESCRIPTION: Sensor Page Power Component
@NAME : index.js
        ...
        this.state = {
            columns: [
                ...
                },
                {
                    ...
                    render: rowData =>
                    (
                        <img src={rowData.Status.Health === 'OK' ? Health_OK_Icon : Health_NOT_OK_Icon} />
                    ), 
                },
                {
                    title: 'Voltage (Volts)',
...
export default withStyles(styles)((connect(mapStateToProps, mapDispatchToProps))(((PowerSensor))));
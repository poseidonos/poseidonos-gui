...
func ResourcesEventsYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "../resources/events.yaml", size: 35126, mode: os.FileMode(420), modTime: time.Unix(1602087579, 0)}

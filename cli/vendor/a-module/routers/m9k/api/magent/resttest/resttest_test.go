...
const (
	IP                  = "127.0.0.1"
	PORT                = "3000"
	LATEST_CPU          = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/cpu"
	LATEST_DISK         = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/disk"
	LATEST_MEMORY       = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/memory"
	LATEST_NETWORK      = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/network"
	CPU                 = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/cpu/1m"
	DISK                = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/disk/1m"
	MEMORY              = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/memory/1m"
	NETWORK             = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/network/1m"
	NETWORK_DRIVER      = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/network/driver"
	NETWORK_HARDWARE    = "http://" + IP + ":" + PORT + "/api/magentmetrics/v1/network/hardwareaddress"

...
#### HTML & Markdown
There are two type documentation in doc folder
* api.html : open with chrome
* api.md : open with markdown editor
...
(GET) /ibofos/v1/system/heartbeat  
Response Sample
```json
{
...
##### [EXIT iBOFOS]
(GET) /ibofos/v1/system/exitibofos  
...
After run ibofos and before creating array, this method should be called.
If success, you mout not create array.
